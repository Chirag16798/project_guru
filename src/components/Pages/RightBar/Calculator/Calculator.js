...
const Calculator = () =>{
    ...
    return(
        ...
        <div className="calculator-grid">
              ...
              <button  className="span-two buttonShadow" onClick={()=>dispatch({type:ACTIONS.CLEAR})} >AC</button>
              <button className="buttonShadow" onClick={()=>dispatch({type:ACTIONS.DELETE_DIGIT})}>DEL</button>
              ...
              <button className="span-two buttonShadow" onClick={()=>dispatch({type:ACTIONS.EVALUATE})}>=</button>
        </div>
        </div>
    )
}
