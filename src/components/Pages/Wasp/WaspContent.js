    ...
    <div className="wasp__table">
      <div className="search">
        <form onSubmit={handelSubmit}>
          <div className="row inputFieldWasp">
            ...
            <div className="col-sm-4">
              ...
              <div className="input-field col-sm-2">
                <button className="wasp-search-btn" onClick={getDataE}>
                  Search
                </button>
              </div>
                ...
                <form>
                  <div className="search-input">
                    <div className="search-inp">
                      <label className="countryLabel">Contact Person:</label>
                      <input
                        type="text"
                        className="inField"
                    ...
                    <div className="search-inp">
                      <label className="countryLabel">Status</label>
                      <select
                        className="inField"
                        onClick={getStatus}
                  ...
                  <div className="search-input">
                    <div className="search-inp">
                      <label className="countryLabel">Company Name</label>
                      <input
                        type="text"
                        className="inField"
                        placeholder="Contact Person"
                    ...
                    <div className="search-inp">
                      <label className="countryLabel">Category</label>
                      {/* <Multiselect
                        onClick={getCategory}
                  ...
                  <div className="search-input">
                    <div className="search-inp">
                      <label className="countryLabel">Mobile No. 1</label>
                      <input
                        type="tel"
                        className="inField"
                    ...
                    <div className="search-inp">
                      <label className="countryLabel">Notes</label>
                      <input
                        type="text"
                        className="inField"
                        placeholder="Notes"
                  ...
                  <div className="search-input">
                    <div className="search-inp">
                      <label className="countryLabel">Skype</label>
                      <input
                        type="text"
                        className="inField"
                        placeholder="Skype"
                    ...
                    <div className="search-inp">
                      <label className="countryLabel">Website</label>
                      <input
                        type="text"
                        className="inField"
                        placeholder="Website"
                    ...
                    <div className="search-inp mt-5">
                      <label className="countryLabel">Show In</label>
                      <input
                        type="radio"
                        name="show"
                        id="check"
                      ...
                      />
                      <label  className="countryLabel">Wasp</label>
                      <input
                        type="radio"
                        name="show"
                        id="check"
                        ...
                        onChange={(e) => setWaspTact(e.target.value)}
                      />
                      <label className="countryLabel">Tact</label>
                    </div>
                  </div>
