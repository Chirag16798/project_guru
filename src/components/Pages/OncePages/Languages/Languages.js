...
const Languages = () => {
  ...
  return (
    <div className={`con ${inactive ? "con-act" : ""}`} onLoad={getLanguage}>
      ...
      />
      <OnceHeader heading="Languages" />
      <div className="once-content">
        <div className="once-head">
          {show ? <h2 className="modHeading">Add Languages</h2> : null}
          {show ? (
            ...
            <div className="input-field">
              <div className="select">
                <div className="time-zone f-b">
                  <label className="countryLabel">Language Name</label>
                  <input
                    type="text"
                    className="inField"
                ...
                <div className="dropdown f-b">
                  <label className="countryLabel">Country-used in</label>
                  <select
                ...
                <div className="btn">
                  <button className="save-btn me-3" onClick={checkInputData}>
                    Save
                  </button>
                  <button
        ...
        {show ? (
          <div className="once-search">
            <h2 className="modHeading">Search Language</h2>
            <form>
