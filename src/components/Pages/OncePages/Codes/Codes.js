    ...
    <div className={`con ${inactive ? "con-act" : ""}`} onLoad={getCode}>
      ...
      <div className="once-content currency">
        <div className="once-head">
          {show ? <h2 className="modHeading">Add Codes</h2> : null}
            ...
            <div className="input-field">
              <div className="select">
                <div className="alias f-b">
                  <label className="countryLabel">Codes Name</label>
                  <input
                    type="text"
                    className="inField"
                    id="code_value"
                ...
                <div className="time-zone f-b">
                  <label className="countryLabel">Code Defined as</label>
                  <input
                    type="text"
                    className="inField"
                    id="code_value"
                ...
                <div className="btn">
                  <button className="save-btn me-4" onClick={checkInputData}>
                    Save
                  </button>
                  <button
        ...
        {show ? (
          <div className="once-search">
            <h2 className="modHeading">Search Codes</h2>
            <form>
