    ...
    <div className={`con ${inactive ? "con-act" : ""}`} onLoad={wholeData}>
      ...
      <div className="once-content currency">
        <div className="once-head">
          {show ? <h2 className="modHeading">Add Currency</h2> : null}
            ...
            <div className="input-field">
              <div className="select">
                <div className="time-zone f-b">
                  <label className="countryLabel">Currency Name</label>
                  <input
                    type="text"
                    className="inField"
                ...
                <div className="alias f-b">
                  <label className="countryLabel">{`Alias (if any)`}</label>
                  <input
                    type="text"
                    className="inField"
                    placeholder="Alias"
                ...
                <div className="time-zone f-b">
                  <label className="countryLabel">Currency Symbol</label>
                  <input
                    type="text"
                    className="inField"
                ...
                <div className="btn">
                  <button
                    className="save-btn curr-btn me-3"
        ...
        {show ? (
          <div className="once-search">
            <h2 className="modHeading">Search Currency</h2>
            <form>
          ...
          <table>
            <thead>
              <tr>
                ...
                <th className="st-bg actionSl">Action</th>
              </tr>
            </thead>
