    ...
    <div className={`con ${inactive ? "con-act" : ""}`} onLoad={getWorkType}>
      ...
      <div className="once-content currency">
        <div className="once-head">
          {show ? <h2 className="modHeading">Add Work Type</h2> : null}
          {show ? (
          ...
          <form>
            <div className="measure">
              <div className="measure-inp">
                <label className="countryLabel">Work Type Name</label>
                <input
                  type="text"
                  className="inField"
        ...
        {show ? (
          <div className="once-search">
            <h2 className="modHeading">Search Work Type</h2>
            <form>
            ...
            <tbody>
              {worklist
                ...
                .map((val, key) => {
                  return (
                    <tr>
                      <td className="actionSl">{val.serial_number}</td>
                      <td>{val.work_type}</td>
                      <td className="action">
                        <ul>
                          <li
