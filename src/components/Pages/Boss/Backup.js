      ...
      <div className="inner-container">
        <div className="backup-content">
          <div className="restore">
            <label className="modHeading">Restore</label>
            <div className="restore-content">
              <div className="restore-choose">
                <label className="countryLabel">Browse File</label>
                <input type="file"  className="addUserImg" />
          ...
          <div className="backup">
            <h2 className="modHeading">Backup</h2>
            <div className="backup-content">
              {hide ? (
                <p className="backup-text">DB Backup is in Progress !!</p>
              ) : null}
              <button
                className={`backup-btn-1 back-w ${hide ? "btn-display" : ""} `}
