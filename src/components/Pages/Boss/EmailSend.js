            ...
            <div className="container bordered">
              <div className="row mx-auto">
                <div className="col-sm-11 mx-auto">
                  <label className="countryLabel">Subject</label>
                  <input
                  type="text"
                  id="subject_email"
              ...
              <div className="row my-3 mx-auto">
                <div className="col-sm-5 mx-auto">
                  <label className="countryLabel">Email To</label>
                  <textarea
                  className="form-control inField"
                ...
                <div className="col-sm-5 mx-auto">
                <h6 className="countryLabel">Email content</h6>
                <textarea
                  type="text"
              ...
              <div className="row my-3 mx-auto">
                ...
                <h6 className="countryLabel">Browse File</h6>
                <input
