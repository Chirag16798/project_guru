    ...
    >
      ...
      <div className="inner-container">
        <div className="permission-form">
          <form>
            <div className="user">
              <label className="countryLabel me-4">Users</label>
              <select
                id="country"
                name="country"
                className="user-select inField"
                onClick={onClick}
                onChange={(e) => {
            ...
            <div className="user-checkbox">
              ...
              <div className="alias f-b user-cc">
                <label className="countryLabel">User CC(Email id)</label>
                <div className="col-sm-8">
                <input type="text" placeholder="User CC(Email id)" className="inField"/>
                </div>
